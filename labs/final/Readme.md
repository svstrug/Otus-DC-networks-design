...
<details>
<summary> POD2-R2 </summary>
 
 ```
POD2-R2#sh run
! Command: show running-config
! device: POD2-R2 (vEOS-lab, EOS-4.29.2F)
!
! boot system flash:/vEOS-lab.swi
!
no aaa root
...
!
interface Ethernet1
   description POD2-Spine-2 | Eth6
   no switchport
   ip address 10.20.2.11/31
!
interface Ethernet2
!
interface Ethernet3
...
ip prefix-list routed_net_PAK374_in seq 30 permit 192.168.111.0/24 le 32
ip prefix-list routed_net_PAK374_in seq 40 permit 192.168.100.0/24 le 32
ip prefix-list routed_net_PAK374_out seq 10 permit 2.2.2.2/32
!
router bgp 31133
   router-id 2.2.2.2
   neighbor 10.20.2.10 remote-as 65501
   neighbor 10.20.2.10 description to_POD2-Spine-2
   !
   address-family ipv4
      neighbor 10.20.2.10 activate
      neighbor 10.20.2.10 prefix-list routed_net_PAK374_in in
      neighbor 10.20.2.10 prefix-list routed_net_PAK374_out out
      network 2.2.2.2/32
!
end
```
...
<details>
<summary> POD2-Spine-1 </summary>
 
 ```
POD2-Spine-1#show running-config
! Command: show running-config
! device: POD2-Spine-1 (vEOS-lab, EOS-4.29.2F)
!
! boot system flash:/vEOS-lab.swi
!
no aaa root
...
!
interface Ethernet4
   description POD2-Leaf-4 | Eth1
   mtu 9000
   no switchport
   ip address 10.20.1.6/31
   isis enable Underlay
   isis network point-to-point
!
interface Ethernet5
   description POD1-Spine-1 | Eth5
   mtu 9000
   no switchport
...
!
interface Ethernet6
   description POD2-R1 | Eth1
   no switchport
   vrf vrf-vxlan
   ip address 10.20.1.10/31
!
interface Ethernet7
!
interface Ethernet8
...
interface Loopback1
   description underlay
   ip address 10.16.1.0/32
   isis enable Underlay
   isis passive
!
interface Loopback2
   description overlay
   ip address 10.18.1.0/32
   isis enable Underlay
   isis passive
!
interface Management1
...
router bgp 65501
   ...
   neighbor 10.2.1.0 update-source Loopback2
   neighbor 10.2.1.0 description to_POD1-Spine-1
   neighbor 10.2.1.0 ebgp-multihop 3
   neighbor 10.2.1.0 password 7 AB64UUTt4xnYcfY31sz6Rg==
   ...
   vrf vrf-vxlan
      ...
      route-target import evpn 1:50000
      route-target export evpn 1:50000
      neighbor 10.20.1.11 remote-as 31133
      neighbor 10.20.1.11 description to_POD2-R1
      redistribute connected
!
router isis Underlay
   net 49.0052.0100.0000.1200.00
   is-type level-1
   !
   address-family ipv4 unicast
!
...
<details>
<summary> POD2-Leaf-1 </summary>
 
 ```
POD2-Leaf-1#show running-config
! Command: show running-config
! device: POD2-Leaf-1 (vEOS-lab, EOS-4.29.2F)
!
! boot system flash:/vEOS-lab.swi
!
no aaa root
...
interface Port-Channel3
   ...
   !
   evpn ethernet-segment
      identifier 00aa:aaaa:aaaa:aaaa:aaaa
      route-target import aa:aa:aa:aa:aa:aa
   lacp system-id 2222.2222.2222
!
interface Ethernet1
   description POD2-Spine-1 | Eth1
   mtu 9000
   no switchport
...
<details>
<summary> POD2-Leaf-2 </summary>
 
 ```
POD2-Leaf-2#sh run
! Command: show running-config
! device: POD2-Leaf-2 (vEOS-lab, EOS-4.29.2F)
!
! boot system flash:/vEOS-lab.swi
!
no aaa root
...
<details>
<summary> POD2-Leaf-3 </summary>
 
 ```
POD2-Leaf-3#show running-config
! Command: show running-config
! device: POD2-Leaf-3 (vEOS-lab, EOS-4.29.2F)
!
! boot system flash:/vEOS-lab.swi
!
no aaa root
...
<details>
<summary> POD2-MngSW-1 </summary>
 
 ```
POD2-MngSW-1#show running-config
! Command: show running-config
! device: POD2-MngSW-1 (vEOS-lab, EOS-4.29.2F)
!
! boot system flash:/vEOS-lab.swi
!
no aaa root
...
!
interface Port-Channel1
   description POD2-Leaf-1-2
   switchport trunk allowed vlan 12-17,100,111
   switchport mode trunk
!
interface Ethernet1
   description POD2-Leaf-1 | Eth3
   channel-group 1 mode active
   lacp timer fast
!
interface Ethernet2
   description POD2-Leaf-2 | Eth3
   channel-group 1 mode active
   lacp timer fast
!
interface Ethernet3
...
<summary> POD1-Spine-1 diag </summary>
 ...
 ```
POD1-Spine-1#show bgp summary vrf vrf-vxlan
BGP summary information for VRF vrf-vxlan
Router identifier 10.4.1.10, local AS number 65500
Neighbor           AS Session State AFI/SAFI                AFI/SAFI State   NLRI Rcd   NLRI Acc
--------- ----------- ------------- ----------------------- -------------- ---------- ----------
10.4.1.11       31133 Established   IPv4 Unicast            Negotiated              1          1
